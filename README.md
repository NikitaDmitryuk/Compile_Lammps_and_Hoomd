...
Для его замены необходимо поменять строку на свою, в которой рассчитывается сила взаимодействия между частицами (желательно в обеих функциях):
...
Сила взаимодействия рассчитывается как *force = - u' / r*, где *u* - нужный потенциал взаимодействия.
